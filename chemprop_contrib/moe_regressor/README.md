...
The works by passing the learned representation from message passing into one "gating network" and a configurable number of "experts".
...
## References
R. A. Jacobs, M. I. Jordan, S. J. Nowlan and G. E. Hinton, "Adaptive Mixtures of Local Experts" Neural Computation, vol. 3, no. 1, pp. 79-87, March 1991, doi: [10.1162/neco.1991.3.1.79](https://doi.org/10.1162/neco.1991.3.1.79).
